...
save_dir_path = signalmcmed_dir_path + "/evaluation_val_1min_moment-base"
...
with open(signalmcmed_dir_path + "/extract-features_moment-base_1min_ecg.pkl", "rb") as f:
    features_1min_ecg = pickle.load(f)
print(features_1min_ecg.shape)
with open(signalmcmed_dir_path + "/extract-features_moment-base_1min_ppg.pkl", "rb") as f:
