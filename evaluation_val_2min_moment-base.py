...
save_dir_path = signalmcmed_dir_path + "/evaluation_val_2min_moment-base"
...
with open(signalmcmed_dir_path + "/extract-features_moment-base_2min_ecg.pkl", "rb") as f:
    features_2min_ecg = pickle.load(f)
print(features_2min_ecg.shape)
with open(signalmcmed_dir_path + "/extract-features_moment-base_2min_ppg.pkl", "rb") as f:
