...
save_dir_path = signalmcmed_dir_path + "/evaluation_val_30sec_moment-base"
...
with open(signalmcmed_dir_path + "/extract-features_moment-base_30sec_ecg.pkl", "rb") as f:
    features_30sec_ecg = pickle.load(f)
print(features_30sec_ecg.shape)
with open(signalmcmed_dir_path + "/extract-features_moment-base_30sec_ppg.pkl", "rb") as f:
