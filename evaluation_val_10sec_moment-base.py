...
save_dir_path = signalmcmed_dir_path + "/evaluation_val_10sec_moment-base"
...
with open(signalmcmed_dir_path + "/extract-features_moment-base_10sec_ecg.pkl", "rb") as f:
    features_10sec_ecg = pickle.load(f)
print(features_10sec_ecg.shape)
with open(signalmcmed_dir_path + "/extract-features_moment-base_10sec_ppg.pkl", "rb") as f:
    features_10sec_ppg = pickle.load(f)
print(features_10sec_ppg.shape)
# (all have shape: [num_csns, feature_dim])

with open(signalmcmed_dir_path + "/extract-features_moment-base_csns.pkl", "rb") as f:
