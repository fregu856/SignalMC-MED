...
for i, csn in enumerate(csns):
    ...
    for batch_i, ecgs in enumerate(loader):
        ...
        # print(ecgs.shape)
        with torch.no_grad():
            features_ecg = model(x_enc=ecgs).embeddings.cpu() # (shape: [batch_size, 768])
    ...
    for batch_i, ppgs in enumerate(loader):
        ...
        # print(ppgs.shape)
        with torch.no_grad():
            features_ppg = model(x_enc=ppgs).embeddings.cpu() # (shape: [batch_size, 768])
...
with open(signalmcmed_dir_path + "/extract-features_moment-base_csns.pkl", "wb") as f:
    pickle.dump(preprocessed_csns, f)

with open(signalmcmed_dir_path + "/extract-features_moment-base_10min_ecg.pkl", "wb") as f:
    pickle.dump(features_10min_ecg, f)
with open(signalmcmed_dir_path + "/extract-features_moment-base_5min_ecg.pkl", "wb") as f:
    pickle.dump(features_5min_ecg, f)
with open(signalmcmed_dir_path + "/extract-features_moment-base_2min_ecg.pkl", "wb") as f:
    pickle.dump(features_2min_ecg, f)
with open(signalmcmed_dir_path + "/extract-features_moment-base_1min_ecg.pkl", "wb") as f:
    pickle.dump(features_1min_ecg, f)
with open(signalmcmed_dir_path + "/extract-features_moment-base_30sec_ecg.pkl", "wb") as f:
    pickle.dump(features_30sec_ecg, f)
with open(signalmcmed_dir_path + "/extract-features_moment-base_10sec_ecg.pkl", "wb") as f:
    pickle.dump(features_10sec_ecg, f)

with open(signalmcmed_dir_path + "/extract-features_moment-base_10min_ppg.pkl", "wb") as f:
    pickle.dump(features_10min_ppg, f)
with open(signalmcmed_dir_path + "/extract-features_moment-base_5min_ppg.pkl", "wb") as f:
    pickle.dump(features_5min_ppg, f)
with open(signalmcmed_dir_path + "/extract-features_moment-base_2min_ppg.pkl", "wb") as f:
    pickle.dump(features_2min_ppg, f)
with open(signalmcmed_dir_path + "/extract-features_moment-base_1min_ppg.pkl", "wb") as f:
    pickle.dump(features_1min_ppg, f)
with open(signalmcmed_dir_path + "/extract-features_moment-base_30sec_ppg.pkl", "wb") as f:
    pickle.dump(features_30sec_ppg, f)
with open(signalmcmed_dir_path + "/extract-features_moment-base_10sec_ppg.pkl", "wb") as f:
