...
save_dir_path = signalmcmed_dir_path + "/evaluation_test_10min_xecg-10min"
...
with open(signalmcmed_dir_path + "/extract-features_xecg-10min_10min_ecg.pkl", "rb") as f:
    features_10min_ecg = pickle.load(f)
print(features_10min_ecg.shape)
with open(signalmcmed_dir_path + "/extract-features_xecg-10min_10min_ppg.pkl", "rb") as f:
    features_10min_ppg = pickle.load(f)
print(features_10min_ppg.shape)
# (all have shape: [num_csns, feature_dim])

with open(signalmcmed_dir_path + "/extract-features_xecg-10min_csns.pkl", "rb") as f:
