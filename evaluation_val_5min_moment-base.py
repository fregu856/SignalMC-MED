...
save_dir_path = signalmcmed_dir_path + "/evaluation_val_5min_moment-base"
...
with open(signalmcmed_dir_path + "/extract-features_moment-base_5min_ecg.pkl", "rb") as f:
    features_5min_ecg = pickle.load(f)
print(features_5min_ecg.shape)
with open(signalmcmed_dir_path + "/extract-features_moment-base_5min_ppg.pkl", "rb") as f:
